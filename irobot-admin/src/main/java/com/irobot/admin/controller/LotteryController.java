...
public class LotteryController {
    ...
    @RequestMapping("/test")
    public Map<String, Object> test(int times) {
...
//        int times = 1000;
        ...
        map.put("一等奖中奖次数：", prize1GetTimes);
        map.put("二等奖中奖次数:", prize2GetTimes);
        map.put("三等奖中奖次数:" , prize3GetTimes);
        map.put("四等奖中奖次数：" , prize4GetTimes);
        map.put("五等奖中奖次数：" , prize5GetTimes);
        map.put("六等奖中奖次数：" , prize6GetTimes);
        map.put("六等奖2中奖次数：" , prize7GetTimes);
        map.put("未中奖次数：" , prize8GetTimes);
